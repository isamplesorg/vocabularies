...
[]{#iSamplesMaterialSampleTypeVocabulary(superseded)}

# **Concept scheme:** iSamples Material Sample Type Vocabulary (superseded)
...
* 2024-04-19 SMR. Decision to update terminology to use 'material sample' consistently, result in changing vocabulary uri, and uris for various concepts in the vocabulary. This vocabulary superseded by https://w3id.org/isample/vocabulary/materialsampleobjecttype/1.0/conceptscheme.
